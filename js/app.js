                        ...
                        if (coins[i2].id == newCoins[i1].id && coins[i2].price_usd != newCoins[i1].price_usd) {
                            this.notify({
                                ...
                                body: newCoins[i1].name +
                                    "\nOld: " + $filter('currency')(coins[i2][$rootScope.NAME_PRICE], $rootScope.SELECTED_COIN + ' ') +
                                    "\nNew: " + $filter('currency')(newCoins[i1][$rootScope.NAME_PRICE], $rootScope.SELECTED_COIN + ' ') +
                                    "\nVar: " + $filter('currency')(newCoins[i1][$rootScope.NAME_PRICE] - coins[i2][$rootScope.NAME_PRICE], $rootScope.SELECTED_COIN + ' ') +
                                    "\nPer: " + ((newCoins[i1][$rootScope.NAME_PRICE] / coins[i2][$rootScope.NAME_PRICE] - 1) * 100).toFixed(4) + "%",
